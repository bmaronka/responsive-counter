...
class _$CounterImpl implements _Counter {
  _$CounterImpl({required this.index, this.count = 0});
  ...
  @override
  String toString() {
    return 'Counter(index: $index, count: $count)';
  }
...
abstract class _Counter implements Counter {
  factory _Counter({required final int index, final int count}) = _$CounterImpl;
